...
public class TowerScript : MonoBehaviour
{
    ...
    private EnemyScript _targetEnemy;
    ...
    public void CheckNearestEnemy(List<EnemyScript> enemies)
    {
    ...
    public void ShootTarget()
    {
        ...
        if (_runningShootDelay <= 0f)
        {
            ...
            BulletScript bullet = LevelManagerScript.Instance.GetBulletFromPool(_bulletPrefab);
    ...
    public void SetTowerHeadIcon(Sprite spr) => _towerHead.sprite = spr;
}